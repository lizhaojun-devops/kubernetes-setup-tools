...
ssh root@${OPS_HOST} "source /etc/profile; kubectl describe clusterrole system:kube-controller-manager"
sleep 3s
ssh root@${OPS_HOST} "source /etc/profile; kubectl describe clusterrole system:controller:deployment-controller"
#查看当前的 leader
ssh root@${OPS_HOST} "source /etc/profile; kubectl get endpoints kube-controller-manager --namespace=kube-system  -o yaml"
